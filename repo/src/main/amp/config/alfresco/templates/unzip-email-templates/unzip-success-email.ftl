                           ...
                           <tr>
                              <td style="padding: 20px 30px 0px;">
                                 <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                    <tr>
                                       <td>
                                          <div style="font-size: 22px; padding-bottom: 4px; color: green;">
                                          	 ${message("unzip.email.title.success")}
                                          </div>
                                          ...
                                          <div style="font-size: 14px; margin: 18px 0px 24px 0px; padding-top: 18px; border-top: 1px solid #aaaaaa;">
                                             <#if documents?exists && documents?size &gt; 0>
                                             <#list documents as document>
                                                <div class="document">
	                                                <#assign documentLink="<a href=\"${shareUrl}/page/document-details?nodeRef=${document.nodeRef}\">${document.name}</a>">
                                                	${documentLink}
                                                </div>
                                             </#list>
                                             </#if>
